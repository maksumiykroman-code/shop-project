  ...
  return (
    <div className="p-8 bg-black min-h-screen text-white">
      <div className="max-w-5xl mx-auto flex justify-between items-center mb-12 border-b border-zinc-800 pb-6">
        <h1 className="text-2xl font-bold uppercase tracking-widest text-orange-500">Адмін-панель запрацювала</h1>
        <button 
      ...
      <p>Тепер ти можеш додавати товари. Пароль активний.</p>
    </div>
  );
}
